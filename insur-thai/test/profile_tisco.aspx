<%@ Page Language="C#" AutoEventWireup="true" CodeFile="profile_tisco.aspx.cs" Inherits="test_profile" %>
                        ...
                        <table border="0" cellpadding="0" cellspacing="0" class="logo">
                            <tr>
                                <td align="" valign="top" style="padding: 9px 0; width:40px;">    
                                    <img src="http://cdc.tbs.tu.ac.th/wp-content/uploads/2014/07/6.png" width="60" height="60" alt="VSTS" class="img-block" style="color: #fff;" />
                                </td>
                                <td color="#ffffff" style="padding: 0 5px 0 5px; text-align: left; color: #ffffff; font-family: Segoe UI, Helvetica, Arial, sans-serif; font-size: 16px;">
                                   <b> สินเชื่อรถยนต์ ทิสโก้</b> 
                                </td>
                            </tr>
                        </table>
                    </td>
                        ...
                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                            <tr>
                                            ...
                                            <td align="left" style="padding: 10px 0 25px 0; font-size: 16px; line-height: 25px; font-family: Segoe UI, Helvetica, Arial, sans-serif; color: #444444;" class="mobile-center">
                                                ...
                                                <b>สินเชื่อรถใหม่</b>
                                                   <br />วงเงินสินเชื่อ
                                                    ...
                                                    &nbsp; 75% สำหรับรถบรรทุก
                                                   <br /> ระยะเวลาการเช่าซื้อ : 12-72 เดือน
                                                                        ...
                                                                        <table border="0" cellspacing="0" cellpadding="0" class="mobile-button-container" align="left">
                                                                            <tr>
                                                                                <td align="center" bgcolor="#007acc" style="padding: 0 10px">
                                                                                    <a href="#" target="_blank" style="font-size: 14px; font-family: Segoe UI, Helvetica, Arial, sans-serif; color: #ffffff; text-decoration: none; padding: 6px; border: 2px solid #007acc; display: inline-block;" class="mobile-button btn-primary">รายละเอียดเพิ่มเติม</a>
                                                                                 </td>
                                                                            </tr>
                                                                        </table>
                                                                    </td>
                                ...
                                <td class="mobile-hide" style="text-align: right; width: 40%; padding-left: 5%;">
                                    <img src="https://s3-us-west-2.amazonaws.com/s.cdpn.io/130015/gfx-welcome2x.png" width="180" height="169" class="img-block" />
                               </td>
                            </tr>
                        </table>
                    </td>
