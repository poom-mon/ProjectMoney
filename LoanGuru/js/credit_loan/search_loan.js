...
function RenderPackage() { 
    ...
    // event
    $("._buttonRegist").on("click", function () {
        var url = $(this).data("url");
        $(this).html("<i class=\"fa fa-spinner fa-spin\"></i> <img src=\"../image/btnProgress.gif\" /> Loading...");
        var _objbtn = $(this).parent();
        setTimeout(function () {
            console.log("wait ... ");
            _objbtn.html("สมัครแล้ว..")
        }, 3000); 
