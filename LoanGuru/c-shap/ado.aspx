<%@ Page Title="" Language="C#" MasterPageFile="~/MS_MAIN.master" AutoEventWireup="true" CodeFile="ado.aspx.cs" Inherits="Default2" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="cpnfoot" Runat="Server">
    ...
    <script type="text/javascript">
        ...
        function selectDt() {
                 var _url = "/connect_DB/c-shap/query.aspx/cSelectAdo";
                 var data = {
                     id : 1
                 };
                 return $.ajax({
        ...
        $("#btnInsert").on("click", function () {
            $.when(
             ...
             function fncInsert() {
                 var _url = "/connect_DB/c-shap/query.aspx/cInsertAdo";
             ...
             function fncDel(id) {
                 var _url = "/connect_DB/c-shap/query.aspx/cDeleteAdo";
                 var data = {
                     ID : id
                 };
                 return $.ajax({
             ...
             function fncUpdate(data) {
                 var _url = "/connect_DB/c-shap/query.aspx/cUpdateAdo"; 
                 return $.ajax({
                     type: "POST",
                     url: _url,
                     contentType: "application/json; charset=utf-8",
