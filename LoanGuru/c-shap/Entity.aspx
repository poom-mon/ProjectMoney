<%@ Page Title="" Language="C#" MasterPageFile="~/MS_MAIN.master" AutoEventWireup="true" CodeFile="Entity.aspx.cs" Inherits="Default2" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="cpnfoot" Runat="Server">
   <script src="../JS/File/jquery.1.11.0.min.js" type="text/javascript"></script> 
    <script type="text/javascript">
        ...
        function selectDt() {
            var _url = "/connect_DB/c-shap/query.aspx/cSelectEntity";
            var data = {
                id: 1
            };
            return $.ajax({
        ...
        function fncInsert() {
            var _url = "/connect_DB/c-shap/query.aspx/cInsertEntity";
        ...
        function fncDel(id) {
            var _url = "/connect_DB/c-shap/query.aspx/cDeleteEntity";
            var data = {
                ID: id
            };
            return $.ajax({
        ...
        function fncUpdate(data) {
            var _url = "/connect_DB/c-shap/query.aspx/cUpdateEntity";
            return $.ajax({
                type: "POST",
                url: _url,
                contentType: "application/json; charset=utf-8",
